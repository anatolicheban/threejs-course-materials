...
import { BoxGeometry, ConeGeometry, Float32BufferAttribute, Fog, Group, Mesh, MeshStandardMaterial, PlaneGeometry, PointLight } from 'three'
...
const fog = new Fog(0x262837, 2, 15)
...
gui.add(ambientLight, 'intensity').min(0).max(1).step(0.001).name('amb Intencity')
scene.add(ambientLight)

// Directional light
const moonLight = new THREE.DirectionalLight(0xb9d5ff, 0.12)
moonLight.position.set(4, 5, - 2)
gui.add(moonLight, 'intensity').min(0).max(1).step(0.001).name('dir Intencity')
